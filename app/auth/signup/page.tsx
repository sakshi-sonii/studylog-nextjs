...
import { BookOpen, Mail, Lock, User, Eye, EyeOff, ArrowRight, Shield, Check } from "lucide-react"
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
          ...
          <div className="p-8 space-y-6">
            ...
            <button className="w-full flex items-center justify-center px-4 py-3 border border-gray-200 rounded-xl hover:bg-gray-50 transition-all duration-200 font-medium group">
